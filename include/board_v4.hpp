...
public:
    ...
    Board_v4(const vector<string>& str_board) {
        ...
        for (int i = 0; i < board_size_; ++i) {
            ...
            items_[border_index].neighbors[kDirBottom] = mir_index;
            ...
            items_[border_index].neighbors[kDirLeft] = mir_index;
            ...
            items_[border_index].neighbors[kDirTop] = mir_index;
            ...
            items_[border_index].neighbors[kDirRight] = mir_index;
    ...
    void Cast(short ray_index) {
        history_casts_.emplace_back(ray_index, ray_direction_[ray_index]);
    ...
    void Reduce() {
        ...
        for (auto i = ray_direction_.size(); i < items_.size(); ++i) {
            //cout <<(int)items_[i].row << " " << (int)items_[i].col << endl; 
            assert(items_[i].row >= 0 && items_[i].col >= 0);
        }
